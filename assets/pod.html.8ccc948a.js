import{_ as n,e as s}from"./app.5a40dfb9.js";const a={},e=s(`<h1 id="pod" tabindex="-1"><a class="header-anchor" href="#pod" aria-hidden="true">#</a> Pod</h1><h2 id="\u521B\u5EFA-pod" tabindex="-1"><a class="header-anchor" href="#\u521B\u5EFA-pod" aria-hidden="true">#</a> \u521B\u5EFA Pod</h2><p>\u547D\u4EE4\u884C\u65B9\u5F0F\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>kubectl run mynginx --image<span class="token operator">=</span>nginx --port<span class="token operator">=</span><span class="token number">80</span> --namespace<span class="token operator">=</span>example
