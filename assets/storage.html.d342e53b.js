...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="\u56DE\u6536\u7B56\u7565" tabindex="-1"><a class="header-anchor" href="#\u56DE\u6536\u7B56\u7565" aria-hidden="true">#</a> \u56DE\u6536\u7B56\u7565</h3><p>StorageClass \u7684 reclaimPolicy \u5B57\u6BB5\u53EF\u4EE5\u6307\u5B9A\u4F1A\u641C\u72D0\u7B56\u7565\uFF0C\u53EF\u9009\u4E3A Delete \u548C Retain\uFF0C\u9ED8\u8BA4\u662F Delete\u3002</p><p>Delete\uFF1A\u52A8\u6001\u4F9B\u5E94\u7684 PV \u9ED8\u8BA4\u7684\u7B56\u7565\uFF0C\u5220\u9664\u65F6\u4F1A\u5C06 PV \u4ECE\u96C6\u7FA4\u4E2D\u5220\u9664\uFF0C\u540C\u65F6\u4E5F\u4F1A\u4ECE\u5916\u90E8 NFS \u7B49\u5377\u63D2\u4EF6\u4E2D\u5220\u9664\u3002</p><p>Retain\uFF1A\u624B\u52A8\u521B\u5EFA\u7684 PV \u9ED8\u8BA4\u7684\u7B56\u7565\uFF0C\u7528\u6237\u53EF\u4EE5\u624B\u52A8\u56DE\u6536\u8D44\u6E90\uFF0C\u5F53\u4F7F\u7528 PV \u7684\u5BF9\u8C61\u88AB\u5220\u9664\u65F6\uFF0CPV \u4ECD\u7136\u5B58\u5728\uFF0C\u5BF9\u5E94\u7684\u6570\u636E\u5377\u72B6\u6001\u53D8\u4E3A\u5DF2\u91CA\u653E\u3002</p><h2 id="local" tabindex="-1"><a class="header-anchor" href="#local" aria-hidden="true">#</a> local</h2><p>local \u5377\u6240\u4EE3\u8868\u7684\u662F\u67D0\u4E2A\u88AB\u6302\u8F7D\u7684\u672C\u5730\u5B58\u50A8\u8BBE\u5907\uFF0C\u53EA\u80FD\u7528\u4F5C\u9759\u6001\u521B\u5EFA\u7684\u6301\u4E45\u5377\uFF0C\u4E0D\u652F\u6301\u52A8\u6001\u914D\u7F6E\u3002\u5982\u679C\u8282\u70B9\u53D8\u5F97\u4E0D\u5065\u5EB7\uFF0C\u90A3\u4E48 local \u5377\u4E5F\u5C06\u53D8\u5F97\u4E0D\u53EF\u88AB Pod \u8BBF\u95EE\u3002\u672C\u5730\u5377\u4E0D\u652F\u6301\u52A8\u6001\u7EB8\u676F\uFF0C\u4F46\u662F\u8FD8\u662F\u9700\u8981\u521B\u5EFA StorageClass \u4EE5\u5EF6\u8FDF\u5377\u7ED1\u5B9A\uFF0C\u76F4\u5230\u5B8C\u6210 Pod \u8C03\u5EA6\uFF0C\u8FD9\u662F\u7531 WaitForFirstConsumer \u5377\u7ED1\u5B9A\u6A21\u5F0F\u6307\u5B9A\u7684\u3002</p><p>\u4F7F\u7528\u4E0B\u9762\u7684\u914D\u7F6E\u6587\u4EF6\u521B\u5EFA\u4E00\u6B21 Deployment \u5E76\u6302\u8F7D local \u5377\uFF1A</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">kind</span><span class="token punctuation">:</span> StorageClass
<span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> storage.k8s.io/v1
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">name</span><span class="token punctuation">:</span> local<span class="token punctuation">-</span>storage
<span class="token key atrule">provisioner</span><span class="token punctuation">:</span> kubernetes.io/no<span class="token punctuation">-</span>provisioner
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>\u5728\u4E3B\u8282\u70B9\u6267\u884C\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#nfs\u4E3B\u8282\u70B9</span>
...
exportfs -r
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>\u5728\u4ECE\u8282\u70B9\u6267\u884C\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#\u6267\u884C\u4EE5\u4E0B\u547D\u4EE4\u6302\u8F7D nfs \u670D\u52A1\u5668\u4E0A\u7684\u5171\u4EAB\u76EE\u5F55\u5230\u672C\u673A\u8DEF\u5F84 /root/nfsmount</span>
<span class="token function">mkdir</span> -p /nfs/data
<span class="token function">mount</span> -t nfs master:/nfs/data /nfs/data
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>NFS \u6CA1\u6709\u5185\u7F6E\u7684\u5B58\u50A8\u5236\u5907\u5668\uFF0C\u901A\u8FC7\u4E0B\u9762\u7684\u914D\u7F6E\u6587\u4EF6\u6765\u521B\u5EFA\uFF1A</p>`,35),v=n("\u9996\u5148\u6267\u884C"),g={href:"https://github.com/kubernetes-sigs/nfs-subdir-external-provisioner/blob/master/deploy/rbac.yaml",target:"_blank",rel:"noopener noreferrer"},h=n("\u8FD9\u4E2A"),f=n("\u914D\u7F6E\u6587\u4EF6\uFF0C\u521B\u5EFA ServiceAccount\u3002\u6CE8\u610F\u5C06\u5176\u4E2D\u7684 default \u66FF\u6362\u6210\u8981\u90E8\u7F72\u7684\u547D\u540D\u7A7A\u95F4\u3002"),P=a(`<div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">kind</span><span class="token punctuation">:</span> Deployment
<span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>\u7136\u540E\u521B\u5EFA\u6D4B\u8BD5\u7528 PVC \u53CA Pod\uFF0C\u5E76\u5C06 PVC \u7ED1\u5B9A\u7ED9 Pod\uFF1A</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">kind</span><span class="token punctuation">:</span> PersistentVolumeClaim
<span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
          ...
          <span class="token punctuation">-</span> <span class="token key atrule">path</span><span class="token punctuation">:</span> /config
            ...
            <span class="token key atrule">backend</span><span class="token punctuation">:</span>
              <span class="token key atrule">service</span><span class="token punctuation">:</span>
                ...
                <span class="token key atrule">port</span><span class="token punctuation">:</span>
                  <span class="token key atrule">number</span><span class="token punctuation">:</span> <span class="token number">8000</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br></div></div>`,8);function x(V,_){const p=l("ExternalLinkIcon");return c(),o(u,null,[i,s("p",null,[k,s("a",b,[m,e(p)]),y]),d,s("p",null,[v,s("a",g,[h,e(p)]),f]),P],64)}var M=t(r,[["render",x]]);export{M as default};
